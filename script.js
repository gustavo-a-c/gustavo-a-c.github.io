...
function processamento(){
    ...
    var pot_sistema = parseInt(document.getElementById('carga_teste2').innerHTML.slice(0,-1));
    var carga_teste = parseInt(document.getElementById('carga_teste').innerHTML.slice(0,-1))
    limite1 = pot_sistema
    ...
    for (let i = 0; i<lista_analise2.length; i++){
        if (parseInt(lista_analise2[i][20]) > carga_teste){
    ...
    for (let i = 0; i<lista_analise3.length; i++){
        ...
        codigo_html_resultado += '<a href="https://www.neosolar.com.br"> Kit ' + lista_analise3[i][0] + 
                                 ...
                                 '<br> Potência do inversor: ' + lista_analise3[i][20] +
...
function soma(){
    ...
    var valor_atual = parseInt(document.getElementById('carga_teste').innerHTML.slice(0,-1));
    //alert(valor_atual)
    var valor_a_somar = parseInt(document.getElementById('valor_carga').value);

    var nome_carga = document.getElementById('desc_carga').value;

    var valor_horas = document.getElementById('valor_horas').value
    ...
    // CARGA TESTE 2
    var valor_atual2 = parseInt(document.getElementById('carga_teste2').innerHTML.slice(0,-1));
    var valor_a_somar2 = parseFloat(document.getElementById('valor_carga').value) * parseFloat(valor_horas);
    ...
    var resultado_valor2 = document.getElementById('carga_teste2');
    resultado_valor2.innerHTML = valor_atual2 + 'Wh'

    var campo_texto = document.getElementById('lista_saida');
    campo_texto.value += nome_carga + ' - ' + valor_a_somar + "W - " + valor_horas + "h de uso\n"
    // alert(campo_texto)
}
