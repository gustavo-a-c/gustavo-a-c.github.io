...
function processamento(){
    ...
    const fator_potencia = 3000

    // área que lê o html e define os limites de potência e tensão

    
    var carga_teste = document.getElementById('carga_teste').innerHTML.slice(0,-1)
    limite1 = parseInt(carga_teste)
    limite2 = limite1 + fator_potencia
    ...
    for (let i = 0; i<lista_analise2.length; i++){
        ...
        codigo_html_resultado += '<a href="https://www.neosolar.com.br"> Kit ' + lista_analise2[i][0] + 
                                 '<br>' + codigo_imagem_kit + '<br>' +
                                 '<br> Inversor ' + lista_analise2[i][2] + 
                                 '<br>' + lista_analise2[i][4] + 'x' + lista_analise2[i][5] + ' painéis ' + lista_analise2[i][3] + 
                                 '<br>' + lista_analise2[i][7] + 'x' + lista_analise2[i][8] + ' baterias ' + lista_analise2[i][6] + 
                                 '<br> Energia Disponível Diária: ' + lista_analise2[i][23] + 'W' + 
...
function soma(){
    ...
    campo_texto.value += nome_carga + ' - ' + valor_a_somar + "W\n"
    // alert(campo_texto)
}
